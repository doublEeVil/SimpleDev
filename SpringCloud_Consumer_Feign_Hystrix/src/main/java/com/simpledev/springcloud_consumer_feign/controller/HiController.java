...
public class HiController {
    ...
    public String hi1(@RequestParam(value = "name", defaultValue = "guest") String name) {
        return service1Api.sayHi1(name);
    }

    @RequestMapping("sleep")
    public String hi2(@RequestParam(value = "name", defaultValue = "guest") String name) {
        return service1Api.sayHi2(name);
    }
}
