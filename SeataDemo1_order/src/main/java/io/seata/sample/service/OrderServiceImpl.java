...
public class OrderServiceImpl implements OrderService{
     ...
     * 2.不添加本地事务：创建订单，扣减库存
     *
     * 可能存在java: You aren't using a compiler supported by lombok, so lombok will not work and has been disabled.
     * idea shared vm option :-Djps.track.ap.dependencies=false
     */
    @Override
